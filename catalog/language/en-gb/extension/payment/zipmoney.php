<?php
// Heading
$_['heading_title']				= 'Login and Pay with ZipMoney';
...
$_['text_title'] 				= 'zipMoney- Buy Now, Pay Later';
// Text
$_['text_back']					= 'Back';
$_['text_cart']					= 'Cart';
$_['text_confirm']				= 'Confirm';
$_['text_continue']				= 'Continue';
$_['text_lpa']					= 'Login and Pay with zipMoney';
...
$_['error_shipping_methods']	= 'There was an error retrieving your address from zipMoney. Please contact the shop administrator for help.';
...
$_['error_login_email']			= 'Login failed: %s account email address did not match zipMoney account email address';
$_['error_minimum']             = 'Minimum order amount for Login and Pay with zipMoney is %s!';
